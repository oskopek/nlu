...
def define_flags() -> None:
    ...
    flags.DEFINE_string('expname', 'Roemmele_Sentences_GRU_Rand6_BahdanauAtt', 'Experiment name.')
    ...
    flags.DEFINE_string('attention', 'add', 'Attention type (add ~ Bahdanau, mult ~ Luong, None). Only for Roemmele '
                        'models.')
