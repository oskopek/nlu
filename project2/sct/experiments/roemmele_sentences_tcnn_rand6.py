...
def define_flags() -> None:
    ...
    flags.DEFINE_string('expname', 'Roemmele_Sentences_TCNN_Rand6', 'Experiment name.')
    ...
    flags.DEFINE_integer('epochs', 30, 'Training epoch count')
