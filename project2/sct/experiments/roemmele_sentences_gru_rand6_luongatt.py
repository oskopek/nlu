...
def define_flags() -> None:
    ...
    flags.DEFINE_string('expname', 'Roemmele_Sentences_GRU_Rand6_LuongAtt', 'Experiment name.')
    ...
    flags.DEFINE_string('attention', 'mult', 'Attention type (add ~ Bahdanau, mult ~ Luong, None). Only for Roemmele '
                        'models.')
